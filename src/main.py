...
def train(args, model, model_ce, model_moco, classifier, classifier_ce, dataset_loaders, optimizer_ce,
...
def main():
    ...
    model_moco = MOCOTuning(network=network, backbone='resnet50', queue_size=args.queue_size,  #'MOCOv2'
