...
class iNaturalist_Plants(ImageList):
    ...
    CLASSES = ['328', '329', '330', '331', '332', '333', '334', '335', '336', '337', '338', '339', '340', '341', '342', '343', '344', '345', '346', '347', '348', '349', '350',
    ...
    def __init__(self, root: str, split: str, label_ratio: Optional[int] =100, download: Optional[bool] = False, **kwargs):
        ...
        super(iNaturalist_Plants, self).__init__(root, iNaturalist_Plants.CLASSES, data_list_file=data_list_file, **kwargs)
