...
class iNaturalist_Peptiles(ImageList):
    ...
    image_list = {
        ...
        "train3": "image_list/train_3.txt",
        "train10": "image_list/train_10.txt",
        "test": "image_list/test.txt",
        "test100": "image_list/test.txt",
    }
    CLASSES = ['163', '164', '165', '166', '167', '168', '169', '170', '171', '172', '173', '174', '175', '176', '177', '178', '179', '180',
    ...
    def __init__(self, root: str, split: str, label_ratio: Optional[int] =100, download: Optional[bool] = False, **kwargs):
        ...
        super(iNaturalist_Peptiles, self).__init__(root, iNaturalist_Peptiles.CLASSES, data_list_file=data_list_file, **kwargs)
